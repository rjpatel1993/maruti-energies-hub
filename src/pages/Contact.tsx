        ...
        <section className="bg-navy py-20 text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-white/70 text-lg max-w-xl mx-auto">
              Request a quote, ask a technical question, or just say hello. We respond within 24 hours.
            </p>
          </div>
        </section>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    placeholder="Please describe your requirement, capacity needed, location, etc."
              ...
              <div className="bg-navy rounded-xl p-6 space-y-4">
                ...
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+919924567355" className="text-white/70 text-sm hover:text-orange transition-colors">+91 99245 67355</a>
                  </div>
                </div>
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:maruties.2019@gmail.com" className="text-white/70 text-sm hover:text-orange transition-colors">maruties.2019@gmail.com</a>
                  </div>
                </div>
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    ...
                    <div className="text-white/70 text-sm">Mon–Sat: 9:00 AM – 6:00 PM IST</div>
                  </div>
                </div>
                <div className="pt-2 border-t border-white/10">
                  <div className="text-white/40 text-xs">GST No: 24BSTPP4394R1ZE</div>
                </div>
              </div>
            </div>
          </div>
