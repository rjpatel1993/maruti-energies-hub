          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  We also own and operate <strong className="text-navy">Mahadev Gas Station</strong> and two dedicated CNG Testing Plants, ensuring every product is validated to the highest safety standards before delivery.
                </p>
                <p>
